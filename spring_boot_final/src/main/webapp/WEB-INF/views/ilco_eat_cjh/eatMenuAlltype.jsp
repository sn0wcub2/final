	...
	<div class="allmenuWrap">
		<div class="allMenuTitle">
			...
			<div class="searchBox">
				...
				<div class="RadBtn">
						<input type="radio" value="Day-B"  name="type" id="type" onchange="location.href='/ilcoeat/menu_all_type/Day-B'" class="radioBtn">
						<label for="Day-B" class="radLab">점심 B-type</label>
				</div>
				<div class="RadBtn">
						<input type="radio" value="Night-A" name="type" id="type" onchange="location.href='/ilcoeat/menu_all_type/Night-A'" class="radioBtn">
						<label for="Night-A" class="radLab">저녁 A-type</label>
				</div>
				<div class="RadBtn">
						<input type="radio" value="Night-B" name="type" id="Night-B" onchange="location.href='/ilcoeat/menu_all_type/Night-B'" class="radioBtn">
