...
<body>
	...
	<div class="inputmenuwraper">
		<div class="inputform">
			...
			<div class="title"><fmt:formatDate value="${ymd}" pattern="MM-dd" /> ${typeLast } 타입</div>
			<form method="post" action="/ilcofoodmange/insertmenu" >
				<div class="submitrow">
					<div class="inputarea">
						<input type='text' id="date-picker" name="menu_date" class='datepicker' placeholder="<fmt:formatDate value="${ymd}" pattern="YYYY-MM-dd" />">
					</div>
				</div>
				<div class="submitrow">
							...
							<div class="searchBox">
								<div class="radio-title-group">
									<c:choose>
										<c:when test="${menu.menu_type == 'Day-A' }">
											<div class="RadBtn">
													<input type="radio" value="Day-A" name="menu_type" id="type" class="radioBtn" checked>
									...
									<c:when test="${menu.menu_type == 'Day-B'}">
											...
											<div class="RadBtn">
													<input type="radio" value="Day-B"  name="menu_type" id="type" class="radioBtn" checked>
													<div class="radio_title">
														<img src="<c:url value='/image/cjh_sun.png'/>" class="type_icon">
														<label for="Day-B" class="radLab">B-type</label>
													</div>
									...
									<c:when test="${menu.menu_type == 'Night-B' }">
										...
										<div class="RadBtn">
												<input type="radio" value="Night-B" name="menu_type" id="type"  class="radioBtn"checked>
												<div class="radio_title">
													<img src="<c:url value='/image/cjh_moon.png'/>" class="type_icon">	
													<label for="Night-B" class="radLab">B-type</label>
												</div>
								...
								<c:when test="${menu.menu_type =='Night-A' }">
									...
									<div class="RadBtn">
										...
										<div class="RadBtn">
												<input type="radio" value="Night-A" name="menu_type" id="type"  class="radioBtn"checked>
												<div class="radio_title">
													<img src="<c:url value='/image/cjh_moon.png'/>" class="type_icon">
													<label for="Night-A" class="radLab">A-type</label>
												</div>
							...
							<div class="check-title-group">
								...
								<c:choose>
									<c:when test="${fn:contains(Lst, '갑각류') }">
										<div class="checkBtn">
											<input type="checkbox" class="allergy" name="allergy" value="갑각류" checked>
											<div class="check_title">
								...
								<c:choose>
									<c:when test="${fn:contains(Lst, '달걀') }">
										<div class="checkBtn">
											<input type="checkbox" class="allergy" name="allergy" value="달걀" checked>
											<div class="check_title">
								...
								<c:choose>
									<c:when test="${fn:contains(Lst, '대두') }">
										<div class="checkBtn">
											<input type="checkbox" class="allergy" name="allergy" value="대두" checked>
											<div class="check_title">
								...
								<c:choose>
									<c:when test="${fn:contains(Lst, '우유') }">
										<div class="checkBtn">
											<input type="checkbox" class="allergy" name="allergy" value="우유" checked>
											<div class="check_title">
								...
								<c:choose>
									<c:when test="${fn:contains(Lst, '땅콩') }">
										<div class="checkBtn">
											<input type="checkbox" class="allergy" name="allergy" value="땅콩" checked>
											<div class="check_title">
								...
								<c:choose>
									<c:when test="${fn:contains(Lst, '복숭아') }">
										<div class="checkBtn">
											<input type="checkbox" class="allergy" name="allergy" value="복숭아" checked>
											<div class="check_title">
